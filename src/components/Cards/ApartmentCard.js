        ...
        <div className="col-md-6 col-lg-4 col-xl-3" >
			<figure className="snip1527" style={{borderRadius: "30px"}} >
				<div className="image">
					...
					<img style={{borderRadius: "30px"}} src={apartment.image} alt={`profile- ${apartment.name}`}  />
				</div>
				<figcaption style={{width: "100%"}}>
					<div >
						<div className="row-full" style={{
							...
							width: "100%",
							position: "relative"}}>
							<span className="text-warning fw-bolder fs-6"><h4>¢{apartment.price}</h4></span>
						</div>
						<div className="row-full" style={{
							borderRadius: "70px",
							width: "100%",
							position: "relative"}}>
							<span className="profile-name"><h4>{apartment.name}</h4></span>
						</div>
						<div className="d-flex justify-content-between" style={{display: "flex", width: "100%", height: '30px'}}>
							...
							<Link to={`/profile/${apartment.id}`} className="btn btn-primary" type="button" style={{
                                color: "#fff",
